...
export const Home: React.FC = () => {
  return (
    <HomeContainer>
      <Hero>
        <Title>Learn to Sing with Kooka!</Title>
        <Subtitle>
      ...
      <Features>
        <FeatureCard className="fade-in">
          <FeatureIcon>K-lesson</FeatureIcon>
          <FeatureTitle>Progressive Lessons</FeatureTitle>
          <FeatureDescription>
        ...
        <FeatureCard className="fade-in">
          <FeatureIcon>K-reward</FeatureIcon>
          <FeatureTitle>Unlock Achievements</FeatureTitle>
          <FeatureDescription>
      ...
      <CTASection>
        <h2>Ready to sing with confidence?</h2>
